...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
        name: "LinkedIn",
        icon: FiLinkedin,
        url: "https://linkedin.com/foster-oppong",
        color: "hover:text-blue-400"
    },
    {
        name: "Email",
        icon: Mail,
        url: "mailto:oppongfoster89@gmail.com",
...
//   animated gradient lline component 
            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="space-y-4">
                        ...
                        >
                            Crafting digital  experience with...
                        </motion.p>
                    </motion.div>
                    {/* social links  */}
                    <motion.div variants={itemVariants} className="flex justify-center space-x-6 mt-6">
                        {socialLinks.map((link, index) => (
                            <motion.a
                                ...
                                className={`p-3 rounded-full transition-all duration-300 ${isDarkMode ? "bg-gray-800/50 hover:bg-gray-700/50" : "bg-gray-100/50 hover:bg-gray-200/50"} ${link.color} backdrop-blur-sm`}
                                whileHover={{
                                    scale: 1.1,
                                    y: -2,
                                    rotate: [0, -5, 5, 0]
                    ...
                    <motion.div variants={itemVariants} className="space-y-2">
                        <p className={`text-sm ${isDarkMode ? "text-gray-500" : "text-gray-600"}`}>
                            © {new Date().getFullYear()} data-detectiv. All right reserved.
                        </p>
                        <p className={`text-xs ${isDarkMode ? "text-gray-600" : "text-gray-500"}`}>
                            Built with React & Framer Motion . Designed with love
                        </p>
                    </motion.div>
